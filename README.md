...
# サービスの差別化ポイント
既存の口コミサービスやSNSは他者に共有することが前提であるため、来店のきっかけにはなる一方で、再訪時にユーザー個々人にあった選択肢を提供する機能は少ないと考えました。\
...
- **ネイティブ化**: UX向上を目的にLINEミニアプリまたはネイティブアプリ化することを計画しています。
- **店舗向けへの情報提供**: 将来的には店舗にフィードバックする機能をつけるなどして、店舗も巻き込む形に進化させたいという思いもあります。
